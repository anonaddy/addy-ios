//
//  EditRecipientDescriptionBottomSheet.swift
//  addy
//
...
struct EditRecipientDescriptionBottomSheet: View {
    ...
    let descriptionEdited: (Recipients) -> Void
        ...
        Form {
            Section {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "edit_desc_recipient_desc"))
    ...
    init(recipientId: String, description: String, descriptionEdited: @escaping (Recipients) -> Void) {
    ...
    private func editDescription(description: String?) async {
        ...
        do {
            if let recipient = try await networkHelper.updateDescriptionSpecificRecipient(recipientId: recipientId, description: description) {
                descriptionEdited(recipient)
            }
        } catch {
            IsLoadingSaveButton = false
...
#Preview {
    EditRecipientDescriptionBottomSheet(recipientId: "000", description: "TEST", descriptionEdited: { _ in
