...
struct AliasRowView: View {
    ...
    init(alias: Aliases, isPreview: Bool) {
        ...
        chartData = [aliasEmailForwardedProgress, aliasEmailRepliedProgress, aliasEmailSentProgress, aliasEmailBlockedProgress]

        if alias.deleted_at != nil {
            do {
                aliasDescription = try String(format: String(localized: "s_s"),
                                              String(format: NSLocalizedString("deleted_at_s", comment: ""),
                                                     DateTimeUtils.convertStringToLocalTimeZoneDate(alias.deleted_at).aliasRowDateDisplay()),
                                              String(format: NSLocalizedString("created_at_s", comment: ""),
                                                     DateTimeUtils.convertStringToLocalTimeZoneDate(alias.created_at).aliasRowDateDisplay()))
            } catch {
            ...
            do {
                aliasDescription = try String(format: String(localized: "s_s_s"),
                                              description,
                                              String(format: NSLocalizedString("created_at_s", comment: ""),
                                                     DateTimeUtils.convertStringToLocalTimeZoneDate(alias.created_at).aliasRowDateDisplay()),
                                              String(format: String(localized: "updated_at_s"),
                                                     DateTimeUtils.convertStringToLocalTimeZoneDate(alias.updated_at).aliasRowDateDisplay()))
            } catch {
